jQuery(function(){
	...
	backgroundColor: "#fe4902"
		...
		jQuery(this).stop().animate({backgroundColor: jQuery(this).attr("rel")}, 300);
	});

	jQuery("#moving-links a").hover(function(){jQuery(this).stop().animate({paddingLeft: "20px"}, 300);},
	function(){jQuery(this).stop().animate({paddingLeft: "0px"}, 300);});
